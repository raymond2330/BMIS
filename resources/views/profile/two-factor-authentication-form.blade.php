<x-jet-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="mt-4 max-w-xl text-sm text-gray-600">
            ...
            <p class="font-semibold text-red-600"> Note that these recovery codes for this account will only be shown once. Save it in a secure location. It is
                recommended to create a single file which contains the recovery codes of the accounts. </p>
        </div>

        ...
        <div class="col-sm-7">
            <div class="card shadow-sm rounded-0 border-white">
                <div class="card-body">
                    ...
                    <h4 class="mt-5 text-center fw-bold tnr text-uppercase">Certificate of Indigency</h4>
                    <div class="container mt-5">
                        <form action="{{route('pdf.indigency')}}" method="post">
                            @csrf
                            <span class="p-form"> &emsp; &emsp;To the best knowledge of this Barangay, <input class="@error('resident_id') error-form @enderror" list="datalistOptions" id="resident_id" name="resident_id" placeholder="Select resident">
            ...
            <button type="submit" class="mt-3 btn btn-dark btn-modern"><i class="fa-solid fa-print"></i> Print Indigency Form</button>
            </form>
        </div>
        <div class="col-sm-5">
            <div class="card shadow-sm rounded-0 border-white">
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="flush-headingOne">
                                <button class="accordion-button collapsed admin-card-text shadow-none bg-white" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                                    How to print Certificate of Indigency form?
                                </button>
                            </h2>
                            <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                <div class="accordion-body">
                                    <ol class="admin-card-text">
                                        <li>Select the resident name from the dropdown menu. It will also generate its complete address accordingly.</li>
                                        ...
                                        <li>Click the <button class="btn btn-dark btn-modern btn-sm"><i class="fa-solid fa-print"></i> Print Indigency Form</button> button.</li>

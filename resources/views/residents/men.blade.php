...
<section class="mt-3 mb-5">
    ...
    <div class="table-responsive">
        <table class="table shadow-sm bg-white caption-top admin-card-text rounded-3" style="width:100%" id="menTable">
            ...
            <tbody class="align-middle">
                ...
                <tr>
                    ...
                    <td> {{$man->household_id}} {{App\Http\Controllers\StreetController::street_name($man->household->street_id)}} St. </td>
                    <td> {{$man->surname}}, {{$man->given_name}}</td>
                    <td data-order="{{$man->age}}">
                        {{$man->age}}

                    </td>
                    <td>
                        @if($man->age < 1) <span class="ms-2 badge rounded-pill fw-normal" style="background-color:#08306b">Infant</span>
                            @elseif($man->age >= 1 && $man->age <= 17) <span class="ms-2 badge rounded-pill fw-normal" style="background-color:#08519c">Child</span>
                                @elseif($man->age >= 18 && $man->age <= 59) <span class="badge rounded-pill fw-normal" style="background-color:#2171b5">Adult</span>
                                    @elseif($man->age >= 60)
                                    <span class="badge rounded-pill fw-normal" style="background-color:#4292c6">Senior</span>
                                    @endif
                    </td>
                    <td><a class="btn btn-sm btn-light" href="{{route('residents.view',$man->id)}}">View</a></td>
                </tr>
                @endforeach
            </tbody>
        </table>

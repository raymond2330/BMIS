...
@section('title', 'Out of school youths')
@section('content')
...
<section class="mt-3 mb-5">
    ...
    <div class="d-flex bd-highlight mb-3">
        <div class="me-auto p-2 bd-highlight">
            <h4 class="card-title">
                ({{ $residents->count() }}) Out of school youths
            </h4>
        </div>
    ...
    <div class="table-responsive">
        <table class="table shadow-sm bg-white caption-top admin-card-text rounded-3" style="width:100%" id="outofschoolTable">
